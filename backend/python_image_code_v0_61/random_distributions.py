...
class Distribution2D():
	...
	def __call__(self, rx, ry):
		...
		#return x, y
		#Previous line modified by Zoltan Beck to sample within the given frame 03.09.2014
		return self.min_x+(self.max_x-self.min_x)*x, self.min_y+(self.max_y-self.min_y)*y
